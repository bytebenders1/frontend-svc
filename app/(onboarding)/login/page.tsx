    ...
    <>
      <div>
        <div className="bg-[#00140F] p-5 sm:flex-col-1">
          <Nav />
          <div className=" bg-[#065646] my-10 flex justify-center mx-auto p-12 ml-5 rounded-lg sm:flex-col-1 ">
            <div className="flex justify-center">
              <div className="">
                <h1 className="text-white lg:ml-20 justify-center text-xl md:text-3xl lg:text-5xl mt-5 font-bold lg:w-[600px] lg:leading-[72.6px]">
                  <span className="text-[#26FCD1]">Secure</span> Your Data,{" "}
                  <br className="!lg:hidden" /> Protect Your{" "}
                  <br className="!lg:hidden" /> Privacy.
                </h1>
          ...
          <div className="p-8">
            ...
            <p className="text-white mt-5 leading-[35px]">
        ...
        <section className="bg-[#04483A] lg:flex justify-between p-10">
          ...
          <div className="">
            ...
            <div className="">
              <h1 className="lg:text-3xl text-center text-bold text-white lg:leading-10 font-Inter">
                “The integration with government services <br /> has made my
                work so much easier. I can <br /> securely share verified
                documents with just a <br /> few clicks.”
              </h1>
